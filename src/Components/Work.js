      ...
      <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
        <div className="flex justify-between items-center">
          <h1 className="text-content md:text-lg lg:text-xl">
            {position || degree} {/* Display Position for Work or Degree for Education */}
          </h1>
          <div className="btn bg-greenbg text-green-text text-xs inline-block rounded-3xl px-3 py-1 min-w-fit">
            {type || field} {/* Display Type for Work or Field for Education */}
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="flex items-center pr-5">
              ...
              <p className="text-content text-xs md:text-sm font-light pl-1">
                {company || school} {/* Display Company for Work or School for Education */}
              </p>
            </div>
        ...
        <p className="pt-4 text-content text-sm font-light">{description}</p>
